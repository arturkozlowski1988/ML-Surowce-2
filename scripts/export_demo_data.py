...
if not df_stock.empty:
    ...
    df_stock["StockLevel"] = df_stock["StockLevel"].apply(lambda x: max(0, x * random.uniform(0.8, 1.2)))
...
if not df_hist.empty:
    ...
    df_hist["Quantity"] = df_hist["Quantity"].apply(lambda x: max(0, x * random.uniform(0.9, 1.1)))
