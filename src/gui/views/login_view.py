...
def render_login_view(on_login_success: Optional[Callable] = None) -> bool:
    ...
    with col2:
        ...
        with st.form("login_form"):
            username = st.text_input("Nazwa użytkownika", placeholder="np. admin", key="login_username")

            password = st.text_input("Hasło", type="password", placeholder="••••••••", key="login_password")
