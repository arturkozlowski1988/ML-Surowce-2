...
class PredictionViewModel(BaseViewModel):
    ...
    def train_model(
        ...
        try:
            ...
            # Get product data
            df_product = self._state.df_prepared[
                self._state.df_prepared['TowarId'] == product_id
            ]
        ...
        try:
            ...
            if not df_predictions.empty:
                ...
                metrics['forecast_change_pct'] = (
                    ...
                    / max(metrics.get('avg_recent', 1), 0.001) * 100
                ) if 'avg_recent' in metrics else 0.0
    ...
    def get_combined_forecast_data(
        ...
        # Get historical data
        hist_data = self._state.df_prepared[
            self._state.df_prepared['TowarId'] == product_id
        ].copy()
