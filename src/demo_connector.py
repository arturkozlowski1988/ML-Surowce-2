...
class DemoDataConnector:
    ...
    def __init__(self, database_name: str = "demo"):
        ...
        logger.info(f"DemoDataConnector initialized (demo mode)")
    ...
    def get_bom_with_stock(self, final_product_id: int, technology_id: int = None, warehouse_ids: List[int] = None) -> pd.DataFrame:
