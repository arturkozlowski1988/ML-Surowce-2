...
class ModelManager:
    ...
    def get_model_count(self) -> int:
        ...
        return len([p for p in self.models_dir.iterdir() 
                   if p.suffix in ['.joblib', '.keras']])
    ...
    def get_best_model_for_product(
        self, 
        product_id: int, 
        metric: str = 'rmse'
    ) -> Optional[SavedModelInfo]:
        """
