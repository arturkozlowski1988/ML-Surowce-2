...
class UserRole(str, Enum):
    ...
    def display_name(self) -> str:
        names = {UserRole.ADMIN: "Administrator", UserRole.PURCHASER: "Zakupowiec"}
...
class AuthManager:
    ...
    def _create_default_admin(self):
        ...
        self.create_user(username="admin", password="admin123", role=UserRole.ADMIN, display_name="Administrator")
    ...
    def _save_users(self):
        ...
        try:
            data = {"users": [asdict(user) for user in self._users.values()]}
    ...
    def create_user(self, username: str, password: str, role: UserRole, display_name: str = None) -> bool:
        """
        Creates a new user.
