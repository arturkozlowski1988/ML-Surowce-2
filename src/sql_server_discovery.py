...
def list_databases(
    server: str, user: str, password: str, use_windows_auth: bool = False
...
def test_connection(
    server: str, database: str, user: str, password: str, use_windows_auth: bool = False
) -> tuple[bool, str]:
    """
...
def save_connection_to_env(
    server: str, database: str, user: str, password: str, use_windows_auth: bool = False, env_path: str = None
) -> tuple[bool, str]:
    """
...
def is_configured() -> bool:
    ...
    placeholders = ["YOUR_PASSWORD_HERE", "YOUR_SERVER", "YOUR_", "PLACEHOLDER"]
...
def get_current_config() -> dict:
    ...
    result = {"server": "", "database": "", "user": "", "configured": False}
